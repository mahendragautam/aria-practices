...
// ===================================================
// QUESTION BANK - LINKED FROM EXTERNAL FILES
// ===================================================
// IMPORTANT: Load all question files BEFORE this script!
// Required external files (must be loaded in HTML):
//   - science-questions.js (defines: scienceQuestions)
//   - math-questions.js (defines: mathQuestions)
//   - history-questions.js (defines: historyQuestions)
//   - geography-questions.js (defines: geographyQuestions)
//   - english-questions.js (defines: englishQuestions)
//   - health-questions.js (defines: healthQuestions)
//   - environment-questions.js (defines: environmentQuestions)
//   - business-questions.js (defines: businessQuestions)
//   - technology-questions.js (defines: technologyQuestions)
//   - parenting-questions.js (defines: parentingQuestions)
