...
,
    ...
    expert: [
            ...
            },
            {
                topic: "Number Riddles - Expert",
                emoji: "🔢💡",
                question: "What number gives the same result when added to itself as when multiplied by itself?",
                options: [
                    "2 or 0",
                    "1",
                    "2",
    ...
    extreme: [
            {
                ...
                emoji: "🔢🧠",
                difficulty: "extreme",
                question: "A number is called 'perfect' if it equals the sum of its proper divisors. What is the smallest perfect number?",
                answer: "6"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢💭",
                difficulty: "extreme",
                question: "You have 12 identical-looking balls. One is slightly heavier or lighter. Using a balance scale only 3 times, how do you identify the odd ball AND determine if it's heavier or lighter? (Describe strategy)",
                answer: "Divide into 3 groups of 4, compare two groups, subdivide based on results and track which balls were in balanced vs unbalanced weighings"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢🎯",
                difficulty: "extreme",
                question: "If f(1) = 1, f(2) = 2, and f(n) = f(n-1) + f(n-2), what is f(10)?",
                answer: "55"
            },
            {
                topic: "Number Riddles - Extreme",
            ...
            },
            {
                ...
                emoji: "🔢💡",
                difficulty: "extreme",
                question: "Three light switches control three bulbs in another room. You can flip switches but only check the room once. How do you determine which switch controls which bulb?",
                answer: "Turn on first switch for several minutes, turn it off, turn on second switch, go check - hot off bulb is first, on bulb is second, cold off bulb is third"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢🧩",
                difficulty: "extreme",
                question: "If you add the square of Tom's age to the age of Mary, the sum is 62. If you add the square of Mary's age to Tom's age, the sum is 176. What are their ages?",
                answer: "Tom is 7, Mary is 13 or Tom is 13, Mary is 7"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢🎪",
                difficulty: "extreme",
                question: "A farmer has chickens and rabbits. He counts 50 heads and 140 legs. How many chickens and rabbits does he have?",
                answer: "30 chickens and 20 rabbits"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢✨",
                ...
                answer: "99/100 or 0.99"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢🌈",
                difficulty: "extreme",
                question: "A rectangular field is 60m by 40m. A horse is tied to a corner with a 30m rope. What area can it graze? (in square meters)",
                answer: "706.86 or approximately 707 square meters"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢🔮",
                difficulty: "extreme",
                question: "In a certain code, MATH is written as 1326. How would you write LOGIC in the same code?",
                answer: "12154"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢💫",
                difficulty: "extreme",
                question: "What is the next number in this sequence: 2, 12, 36, 80, 150, ?",
                answer: "252"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢🎨",
                difficulty: "extreme",
                question: "If you multiply all the digits on a phone keypad (0-9), what's the product?",
                answer: "0"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢🎯",
                difficulty: "extreme",
                question: "A clock takes 5 seconds to strike 6 times. How long will it take to strike 12 times?",
                answer: "11 seconds"
            },
            {
                topic: "Number Riddles - Extreme",
            ...
            },
            {
                ...
                emoji: "🔢🧩",
                difficulty: "extreme",
                question: "What is the smallest number that is divisible by each of the numbers 1 through 12?",
                answer: "27720"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢🎪",
                difficulty: "extreme",
                question: "If you arranged all the numbers from 1 to 1000000, what would be the 1000000th digit you write?",
                answer: "1"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢🌈",
                difficulty: "extreme",
                question: "A merchant can place 8 large boxes or 10 small boxes into a carton. He shipped 96 boxes total in one shipment. The number of cartons was more than 11. What's the total number of cartons?",
                answer: "12"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢💡",
                difficulty: "extreme",
                question: "If f(x) = x² - 3x + 2, what is the value of x when f(x) = 0?",
                answer: "1 or 2"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢🔮",
                difficulty: "extreme",
                question: "Three friends split a restaurant bill. When they add a 15% tip, each owes $34.50. What was the original bill before tip?",
                answer: "90"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢💫",
                difficulty: "extreme",
                question: "What is the smallest positive integer that becomes exactly 9 times larger when its digits are reversed?",
                answer: "1089 becomes 9801"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢🎯",
                difficulty: "extreme",
                question: "In a certain year, there are exactly four Fridays and four Mondays in February. On what day of the week did February 1st fall?",
                answer: "Friday"
            },
            {
                topic: "Number Riddles - Extreme",
                emoji: "🔢✨",
                difficulty: "extreme",
                question: "A number when divided by 7 leaves remainder 4, divided by 11 leaves remainder 8, divided by 13 leaves remainder 3. What is the smallest such number?",
                answer: "184"
            },
            {
                topic: "Number Riddles - Extreme",
