...
const scienceQuestions = {
    ...
    4: { // Chapter 4
        ...
        expert: [
            ...
            {topic: 'Biology', emoji: '🦠🧫', question: 'What is the powerhouse of the cell?', options: ['Mitochondria', 'Nucleus', 'Ribosome', 'Golgi apparatus'], correct: 0},
    ...
    6: { // Chapter 6
        ...
        expert: [
            ...
            {topic: 'Chemistry', emoji: '⚛️💎', question: 'What is Avogadro\'s number?', options: ['6.02×10²³', '3.00×10⁸', '9.11×10⁻³¹', '6.63×10⁻³⁴'], correct: 0},
    ...
    9: { // Chapter 9
        ...
        medium: [
            ...
            {topic: 'Astronomy', emoji: '🌌✨', question: 'What is a light-year?', options: ['Distance', 'Time'], correct: 0},
        ...
        hard: [
            ...
            {topic: 'Astronomy', emoji: '☀️⭐', question: 'What is the solar wind?', options: ['Stream of charged particles', 'Heat from Sun', 'Solar radiation'], correct: 0},
        ...
        expert: [
            ...
            {topic: 'Astronomy', emoji: '🌌⭐', question: 'What is the cosmic distance ladder?', options: ['Series of measurement methods', 'Actual ladder in space', 'Constellation pattern', 'Galaxy classification'], correct: 0},
    ...
    10: { // Chapter 10
        ...
        hard: [
            ...
            {topic: 'Physics', emoji: '🌊💧', question: 'What is the Doppler effect?', options: ['Frequency change with motion', 'Wave reflection', 'Sound amplification'], correct: 0},
        ...
        expert: [
            ...
            {topic: 'Astronomy', emoji: '🪐💍', question: 'What is the Roche limit?', options: ['Tidal disruption distance', 'Orbital distance', 'Escape velocity', 'Gravitational radius'], correct: 0},
    ...
    12: { // Chapter 12
        ...
        extreme: [
            ...
            {topic: 'Astronomy', emoji: '🌌🔭', question: 'What is the cosmic distance ladder?', answer: 'Series of methods to measure distances'},
    ...
    14: { // Chapter 14
        ...
        medium: [
            ...
            {topic: 'Physics', emoji: '⚡💡', question: 'What is the unit of frequency?', options: ['Hertz', 'Decibel'], correct: 0},
    ...
    15: { // Chapter 15
        ...
        medium: [
            ...
            {topic: 'Physics', emoji: '🌊💧', question: 'What is the Doppler effect in sound?', options: ['Frequency change with motion', 'Volume change'], correct: 0},
        ...
        expert: [
            ...
            {topic: 'Physics', emoji: '⚡🔬', question: 'What is the Pauli exclusion principle?', options: ['No identical fermions in same state', 'Energy quantization', 'Wave-particle duality', 'Uncertainty'], correct: 0},
    ...
    16: { // Chapter 16
        ...
        medium: [
            ...
            {topic: 'Biology', emoji: '🌿🍃', question: 'What is transpiration?', options: ['Water vapor loss', 'Photosynthesis'], correct: 0},
    ...
    18: { // Chapter 18
        ...
        medium: [
            ...
            {topic: 'Astronomy', emoji: '☀️⭐', question: 'What is the solar wind?', options: ['Charged particles', 'Light radiation'], correct: 0},
        ...
        extreme: [
            ...
            {topic: 'Physics', emoji: '⚡🔋', question: 'What is the Meissner effect?', answer: 'Magnetic field expulsion from superconductor'},
    ...
    19: { // Chapter 19
        ...
        hard: [
            ...
            {topic: 'Physics', emoji: '🌊💧', question: 'What is Pascal\'s law?', options: ['Pressure transmitted equally', 'Buoyancy', 'Flow rate'], correct: 0},
    ...
    20: { // Chapter 20
        ...
        medium: [
            ...
            {topic: 'Physics', emoji: '🌊💧', question: 'What is the Doppler shift?', options: ['Frequency change', 'Amplitude change'], correct: 0},
        ...
        expert: [
            ...
            {topic: 'Biology', emoji: '🧬💉', question: 'What is horizontal gene transfer?', options: ['Genes between unrelated organisms', 'Parent to offspring', 'Sister chromatids', 'Homologous chromosomes'], correct: 0},
        ...
        extreme: [
            ...
            {topic: 'Astronomy', emoji: '🌟💫', question: 'What is the Schönberg-Chandrasekhar limit?', answer: '10% stellar mass for isothermal core'},
