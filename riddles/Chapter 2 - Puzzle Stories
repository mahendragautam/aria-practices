/**
 * WPCode Snippet #3: Riddles Chapter 2 - Puzzle Stories
 * ==================================================
 * Type: JavaScript
 * Location: Auto Insert > Footer
 * Priority: 10
 * 
 * 100 Questions in Zig-Zag Difficulty Pattern
 * Medium → Hard → Expert → Extreme (repeating)
 *
 * COPY ALL CODE BELOW
 */

const riddlesChapter2 = [
    // Question 1 - Medium (2 options)
    {
    ...
    // Question 84 - Extreme
    {
        ...
        emoji: "🎪💫",
        difficulty: "extreme",
        question: "A man lives on the 15th floor. When he's alone, he takes the elevator to the 10th floor and walks the rest. When he's with someone, he takes it to the 15th. Why?",
        answer: "He's short and can't reach button 15 alone or Needs help reaching higher buttons"
    },
    // Question 85 - Medium
    {
        topic: "Puzzle Stories",
...
if (typeof subjectQuestionBank !== 'undefined') {
    ...
    subjectQuestionBank['riddles'][2] = riddlesChapter2;
}
